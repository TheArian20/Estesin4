...
async function configurarInicioProfesional() {
  ...
  if (perfil.rol === "rector") { if (badge) badge.textContent = "Rectorado"; if (titulo) titulo.textContent = "Consulta la comunidad académica"; if (texto) texto.textContent = "Revisa indicadores institucionales y el equipo académico de STESIN."; if (boton) { boton.textContent = "Abrir Rectorado"; boton.dataset.pagina = "rectorado.html"; } }
