...
async function configurarInicioProfesional() {
  ...
  if (perfil.rol === "rector") { if (badge) badge.textContent = "Rectorado"; if (titulo) titulo.textContent = "Consulta la comunidad académica"; if (texto) texto.textContent = "Revisa el equipo institucional y los recursos disponibles de STESIN."; if (boton) { boton.textContent = "Ver Equipo STESIN"; boton.dataset.pagina = "equipo.html"; } }
